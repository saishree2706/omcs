...
async function fun() {
    ...
    yourUrl = 'http://localhost:3000/patient/getByPhoneNumber/' +
...
async function forgot() {
    ...
    yourUrl = 'http://localhost:3000/patient/getByPhoneNumber/' + document.getElementById("id").value;
    const response = await fetch(yourUrl);
    const json = await response.json();
    ...
    if (json.length == 0) {
        ...
        const url = 'http://localhost:3000/patient/forgotPassword/' + document.getElementById("id").value;
